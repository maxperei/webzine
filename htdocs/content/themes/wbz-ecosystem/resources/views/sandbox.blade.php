...
<div ng-app="myApp" id="app">
	<div ng-controller="WelcomeController" class="wrapper">
		<div class="head">
			<div id="logo">
		...
		<div class="frame clearfix">
			<div id="get-started">
				<div class="container">
					...
					<a href="http://framework.themosis.com/docs/" target="_blank" title="{{ __('Themosis framework documentation', THEME_TEXTDOMAIN) }}">{{ _e('View documentation', THEME_TEXTDOMAIN) }}</a>
				</div>
			</div>
			<div id="links">
				<div class="container">
